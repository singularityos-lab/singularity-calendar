...
Calendar app for the Singularity Desktop.
...
Maintainers may use generative AI tools as assistants while working on singularity-calendar. Non-trivial assisted commits disclose the tool, model, and scope of the work.
